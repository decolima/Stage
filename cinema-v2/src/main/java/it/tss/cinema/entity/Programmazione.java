...
@NamedQueries({
    @NamedQuery(name = Programmazione.FIND_ALL,
                query = "select e from Programmazione e order by e.data_programmazione desc"),
    @NamedQuery(name = Programmazione.FIND_BY_DATA,
                query = "select e from Programmazione e "
                        + "where e.data_programmazione >= :data order by e.data_programmazione"),
    @NamedQuery(name = Programmazione.FIND_BY_FILM,
                query = "select e from Programmazione e "
                        + "where e.film.id= :film_id"),
        @NamedQuery(name = Programmazione.FIND_BY_FILM_AND_DATA,
                query = "select e from Programmazione e "
                        + "where e.film.id= :film_id and e.data_programmazione >= :data "),
        ...
        @NamedQuery(name = Programmazione.DISPONIBILITA_BY_ID,
                query = "SELECT e, b FROM Programmazione e "
                        + "LEFT JOIN FETCH Biglietto b ON b.programmazione.id = e.id "
                        + "WHERE e.id = :id ")
...
public class Programmazione extends AbstractEntity {
    ...
    public static final String DISPONIBILITA_BY_ID = "Programmazione.disponibilitaById";
