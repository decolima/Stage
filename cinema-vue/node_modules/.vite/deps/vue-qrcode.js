...
var lib_default = defineComponent({
  props: {
    ...
    value: {
      ...
      validator(value) {
        ...
        return value.every((it) => typeof it.data === "string" && "mode" in it && MODES.includes(it.mode));
      }
    }
  },
  setup(props, { attrs, emit }) {
    ...
    const toDataURL = () => {
      ...
      import_qrcode.default.toDataURL(value, Object.assign(rest, quality == null || { renderOptions: { quality } })).then((dataUrl) => {
