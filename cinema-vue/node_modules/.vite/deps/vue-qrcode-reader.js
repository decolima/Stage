...
var ri = (n, a, o) => (dr(n, a, "read from private field"), o ? o.call(n) : a.get(n));
var ni = (n, a, o) => {
  if (a.has(n))
    throw TypeError("Cannot add the same private member more than once");
  a instanceof WeakSet ? a.add(n) : a.set(n, o);
};
var oi = (n, a, o, c) => (dr(n, a, "write to private field"), c ? c.call(n, o) : a.set(n, o), o);
function ii(n) {
  if (ai(n))
    return {
...
var ar = (n) => {
  ...
  const o = /* @__PURE__ */ new Set(), c = (m, w) => {
    ...
    ({ BASE_URL: "/", MODE: "production", DEV: false, PROD: true, SSR: false } && "production") !== "production" && console.warn(
...
var vr = (() => {
  ...
  return function(a = {}) {
    ...
    function we(e) {
      o.onAbort && o.onAbort(e), e = "Aborted(" + e + ")", C(e), F = true, e += ". Build with -sASSERTIONS for more info.";
    ...
    function Ir(e) {
      var t = new He(e);
      return t.get_caught() || (t.set_caught(true), Le--), t.set_rethrown(false), We.push(t), Zt(t.excPtr), t.get_exception_ptr();
    }
    var re = 0;
    function jr() {
      D(0);
    ...
    function Br() {
      ...
      var t = e.excPtr;
      throw e.get_rethrown() || (We.push(e), e.set_rethrown(true), e.set_caught(false), Le++), re = t, re;
    }
    function Nr(e, t, r) {
      var i = new He(e);
...
` + s.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    function pn() {
      return this.$$.ptr || dt(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && k("Object already scheduled for deletion"), Te.push(this), Te.length === 1 && Oe && Oe(ht), this.$$.deleteScheduled = true, this;
    }
    function hn() {
    ...
    function Tn(e, t, r, i, s, u, l, f, h, y, _, T, O) {
      ...
      Wt(x, function() {
        ...
        var z = new oe(_, $, true, false, false), N = new oe(_ + "*", $, false, false, false), ye = new oe(_ + " const*", $, false, true, false);
    ...
    function yt(e, t, r, i, s, u) {
      ...
      for (var f = t[1] !== null && r !== null, h = false, y = 1; y < t.length; ++y)
    ...
    function Mn() {
      Q.allocated.push({ value: void 0 }, { value: null }, { value: true }, { value: false }), Q.reserved = Q.allocated.length, o.count_emval_handles = Dn;
    }
    ...
    function jn(e, t, r) {
      ...
      r = Y(r), ne(e, { name: r, fromWireType: u, argPackAdvance: 8, readValueFromPointer: u }, { ignoreDuplicateRegistrations: true });
    }
    function Bt(e, t, r, i) {
      if (!(i > 0))
        return 0;
    ...
    function Kn(e, t) {
      t = Y(t), ne(e, { isVoid: true, name: t, argPackAdvance: 0, fromWireType: function() {
      }, toWireType: function(r, i) {
      } });
    }
    function Zn(e) {
...
`;
    ...
    function nr() {
      if (te > 0 || (ae(), te > 0))
        return;
      function e() {
        Qe || (Qe = true, o.calledRun = true, !F && (Z(), c(o), o.onRuntimeInitialized && o.onRuntimeInitialized(), ot()));
      }
...
var Oi = (n) => new Promise((a) => setTimeout(a, n));
...
var wr = async (n) => await new BarcodeDetector({
  formats: ["qr_code"]
}).detect(n);
var Ri = async (n) => {
...
function ki(n, a, o) {
  return a = Ui(a), a in n ? Object.defineProperty(n, a, { value: o, enumerable: true, configurable: true, writable: true }) : n[a] = o, n;
}
function Ui(n) {
  var a = Fi(n, "string");
...
function Vi(n) {
  ...
  else if (o.webkitGetUserMedia || n.isSecureContext === false && n.webkitRTCPeerConnection)
...
function aa(n) {
  ...
  n.RTCPeerConnection.prototype.createOffer = function(c) {
    if (c) {
      ...
      c.offerToReceiveVideo === false && p ? p.direction === "sendrecv" ? p.setDirection ? p.setDirection("sendonly") : p.direction = "sendonly" : p.direction === "recvonly" && (p.setDirection ? p.setDirection("inactive") : p.direction = "inactive") : c.offerToReceiveVideo === true && !p && this.addTransceiver("video", {
        direction: "recvonly"
      });
    }
...
async function fa(n, { constraints: a, torch: o }) {
  ...
  ge = { videoEl: n, stream: c, isActive: true };
  const [d] = ge.stream.getVideoTracks();
  return ((m = d == null ? void 0 : d.getCapabilities) == null ? void 0 : m.call(d)) ?? {};
}
var la = { class: "qrcode-stream-wrapper" };
var da = { class: "qrcode-stream-overlay" };
var pa = defineComponent({
  ...
  setup(n, { emit: a }) {
    const o = n, c = ref(), d = ref(), p = ref(), m = ref(false), w = ref(false);
    onMounted(() => {
      w.value = true;
    }), onUnmounted(() => {
      bt();
    ...
    watch(b, async (C) => {
      if (C.shouldStream)
        try {
          ...
          w.value ? (m.value = true, a("camera-on", E)) : bt();
        } catch (E) {
          a("error", E);
        }
      else {
        const E = c.value, A = E.getContext("2d"), F = p.value;
        E.width = F.videoWidth, E.height = F.videoHeight, A == null || A.drawImage(F, 0, 0, F.videoWidth, F.videoHeight), bt(), m.value = false, a("camera-off");
      }
    }, { deep: true });
    const v = computed(() => b.value.shouldStream && m.value);
    watch(v, (C) => {
      if (C) {
        P(c.value), P(d.value);
    ...
    return (C, E) => (openBlock(), createElementBlock("div", la, [
...
var ma = ha(pa, [["__scopeId", "data-v-c6aebd5b"]]);
...
var ga = defineComponent({
  ...
  setup(n, { emit: a }) {
    ...
    return (p, m) => (openBlock(), createElementBlock("div", {
      ...
      onDragenter: m[0] || (m[0] = withModifiers((w) => c(true), ["prevent", "stop"])),
      onDragleave: m[1] || (m[1] = withModifiers((w) => c(false), ["prevent", "stop"])),
