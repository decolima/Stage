 ...
 *
 * @author alfonso
 * @author André Lima - User Roles
 */
public class JWTManager {

    private static final String PRIVATE_KEY = "/META-INF/private_key.pem";
    private static final String ISS = "gestioneiot";
    ...
    private JSONObject generateJWT(User usr) {
        long currentTimeInSecs = (System.currentTimeMillis() / 1000); //datetime now
        long expirationTime = currentTimeInSecs + 1800000; //30 minuties
